      ...
      <div className="flex flex-col flex-1 space-y-4 p-6">
        ...
        <div className="flex items-center gap-3 p-2 mt-auto rounded-full bg-[rgba(255,255,255,0.04)]">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 rounded-full border border-[var(--color-gris)] px-4 py-2 text-sm font-semibold text-white transition hover:border-[var(--color-primary)]"
          >
